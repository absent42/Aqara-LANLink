# lumi.curtain.fngl02 -- Curtain Driver

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU |
| Bundle IDs | lumi.aoke.modules |
...
- `2.137.20187` -- `WindowCovering.ObstacleLimitAutoReboundEnable` (Obstacle limit auto rebound enable)
- `2.137.20188` -- `WindowCovering.ObstacleLimitSensitivity` (Obstacle limit sensitivity)
...
_V3 spec totals: 38 traits (9 supported, 0 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

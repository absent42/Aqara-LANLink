# lumi.camera.acn003 -- Camera Hub G2H Pro
...
_V3 spec totals: 81 traits (9 supported, 4 diagnostic, 0 button, 68 dropped). Generated by `tools/render_catalogue_docs.py`._

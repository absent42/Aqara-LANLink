# lumi.valve.agl001 -- Valve Controller T1
...
_V3 spec totals: 46 traits (1 supported, 0 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.lock.acn03 -- Smart Door Lock S2 Pro
...
_V3 spec totals: 39 traits (2 supported, 1 diagnostic, 0 button, 36 dropped). Generated by `tools/render_catalogue_docs.py`._

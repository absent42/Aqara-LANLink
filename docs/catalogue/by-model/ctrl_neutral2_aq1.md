# lumi.ctrl_neutral2.aq1 -- Wall Switch (No Neutral, Double Rocker)
...
_V3 spec totals: 40 traits (4 supported, 0 diagnostic, 0 button, 36 dropped). Generated by `tools/render_catalogue_docs.py`._

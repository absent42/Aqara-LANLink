# lumi.switch.l0agl1 -- Single channel controller T1 single live wire (international version)
...
_V3 spec totals: 39 traits (5 supported, 0 diagnostic, 0 button, 34 dropped). Generated by `tools/render_catalogue_docs.py`._

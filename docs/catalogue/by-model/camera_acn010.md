# lumi.camera.acn010 -- Camera Hub G5 Pro (PoE)
...
_V3 spec totals: 63 traits (4 supported, 5 diagnostic, 0 button, 54 dropped). Generated by `tools/render_catalogue_docs.py`._

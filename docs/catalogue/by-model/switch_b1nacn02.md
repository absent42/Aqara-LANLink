# lumi.switch.b1nacn02 -- Smart Wall Switch D1 (With Neutral, Single Rocker)
...
_V3 spec totals: 46 traits (6 supported, 0 diagnostic, 0 button, 40 dropped). Generated by `tools/render_catalogue_docs.py`._

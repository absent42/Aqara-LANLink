# lumi.dimmer.acn001 -- Smart Constant Current Driver T2
...
_V3 spec totals: 44 traits (9 supported, 0 diagnostic, 0 button, 35 dropped). Generated by `tools/render_catalogue_docs.py`._

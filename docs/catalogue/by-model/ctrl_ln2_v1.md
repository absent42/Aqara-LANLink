# lumi.ctrl_ln2.v1 -- Wall Switch (With Neutral, Double Rocker)
...
_V3 spec totals: 50 traits (9 supported, 0 diagnostic, 0 button, 41 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.ctrl_neutral1.es1 -- Wall Switch (No Neutral, Single Rocker)
...
_V3 spec totals: 37 traits (3 supported, 0 diagnostic, 0 button, 34 dropped). Generated by `tools/render_catalogue_docs.py`._

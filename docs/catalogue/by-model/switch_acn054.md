# lumi.switch.acn054 -- Canon Smart Wall Switch Z1(Triple Rocker)
...
_V3 spec totals: 89 traits (17 supported, 0 diagnostic, 0 button, 72 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.l0acn1 -- Single Switch Module T1 (No Neutral)
...
_V3 spec totals: 36 traits (2 supported, 0 diagnostic, 0 button, 34 dropped). Generated by `tools/render_catalogue_docs.py`._

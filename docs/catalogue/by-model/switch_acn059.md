# lumi.switch.acn059 -- Smart wall switch Z1 Pro (four-button version)
...
- `2.135.20105` -- `Button.SpeedModeSetting` (Speed mode setting)
- `2.135.32928` -- `Button.ButtonEvent` (Button event)
- `2.135.33109` -- `Button.LocalControlDisabled` (Local control disabled)
- `3.132.32920` -- `Output.OnOff` (On off)
- `3.135.32928` -- `Button.ButtonEvent` (Button event)
- `3.135.33109` -- `Button.LocalControlDisabled` (Local control disabled)
- `4.132.32920` -- `Output.OnOff` (On off)
- `4.135.32928` -- `Button.ButtonEvent` (Button event)
- `4.135.33109` -- `Button.LocalControlDisabled` (Local control disabled)
...
_V3 spec totals: 83 traits (15 supported, 0 diagnostic, 0 button, 68 dropped). Generated by `tools/render_catalogue_docs.py`._

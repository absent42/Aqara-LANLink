...
- `2.150.32980` -- `AirQuality.VOCDensity` (VOC density)
- `2.150.32981` -- `AirQuality.VOCQuality` (VOC quality)
- `3.143.32952` -- `Temperature.CurrentTemperature` (Current temperature)
- `4.144.32953` -- `RelativeHumidity.CurrentHumidity` (Current humidity)
...
_V3 spec totals: 54 traits (4 supported, 2 diagnostic, 0 button, 48 dropped). Generated by `tools/render_catalogue_docs.py`._

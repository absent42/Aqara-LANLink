# lumi.switch.agl006 -- Switch H2

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | aqara.zigbee.switch |
...
_V3 spec totals: 60 traits (10 supported, 0 diagnostic, 0 button, 50 dropped). Generated by `tools/render_catalogue_docs.py`._

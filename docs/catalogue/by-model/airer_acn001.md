...
- `2.138.32931` -- `Lifter.CurrentPositionPercentage` (Current position percentage)
- `2.138.32932` -- `Lifter.TargetPositionPercentage` (Target position percentage)
- `2.138.33017` -- `Lifter.TripTime` (Trip time)
...
_V3 spec totals: 44 traits (7 supported, 0 diagnostic, 0 button, 37 dropped). Generated by `tools/render_catalogue_docs.py`._

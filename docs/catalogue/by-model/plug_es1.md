# lumi.plug.es1 -- Smart Plug (China Standard)
...
_V3 spec totals: 41 traits (4 supported, 0 diagnostic, 0 button, 37 dropped). Generated by `tools/render_catalogue_docs.py`._

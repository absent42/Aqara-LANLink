# lumi.aircondition.acn05 -- Air Conditioning Controller P3
...
- `3.139.32940` -- `IRControl.IRType` (IR type)
- `3.139.32972` -- `IRControl.IRKey` (IR key)
...
_V3 spec totals: 63 traits (14 supported, 1 diagnostic, 0 button, 48 dropped). Generated by `tools/render_catalogue_docs.py`._

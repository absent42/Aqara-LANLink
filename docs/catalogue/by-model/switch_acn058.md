# lumi.switch.acn058 -- Smart wall switch Z1 Pro (three-button version)
...
_V3 spec totals: 88 traits (16 supported, 0 diagnostic, 0 button, 72 dropped). Generated by `tools/render_catalogue_docs.py`._

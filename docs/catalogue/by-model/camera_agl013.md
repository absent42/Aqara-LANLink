# lumi.camera.agl013 -- G400 Video Doorbell
...
- `9.170.32928` -- `Doorbell.ButtonEvent` (Button event)
- `9.170.32960` -- `Doorbell.Volume`
...
- `1.147.33089` -- `PowerSource.PowerMode` (Power mode)
- `1.171.20119` -- `NetworkCommissioning.WiFiRSSI` (Wi fi RSSI)
- `7.136.20030` -- `Camera.P2PCaptureEnabled` (P 2 P capture enabled)
- `7.136.20036` -- `Camera.P2PCaptureStatus` (P 2 P capture status)
- `7.136.20369` -- `Camera.CameraRTSPEnable` (Camera RTSP enable)
- `7.136.32930` -- `Camera.CameraActiveStatus` (Camera active status)
- `8.136.20030` -- `Camera.P2PCaptureEnabled` (P 2 P capture enabled)
- `8.136.20036` -- `Camera.P2PCaptureStatus` (P 2 P capture status)
- `8.136.20369` -- `Camera.CameraRTSPEnable` (Camera RTSP enable)
- `8.136.32930` -- `Camera.CameraActiveStatus` (Camera active status)
...
- `7.136.20368` -- `Camera.CameraRTSPURL` (Camera RTSPURL)
- `8.136.20368` -- `Camera.CameraRTSPURL` (Camera RTSPURL)
...
_V3 spec totals: 69 traits (5 supported, 11 diagnostic, 0 button, 53 dropped). Generated by `tools/render_catalogue_docs.py`._

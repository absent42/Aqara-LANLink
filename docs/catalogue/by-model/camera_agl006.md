# lumi.camera.agl006 -- Doorbell Camera Hub G410
...
- `2.170.32928` -- `Doorbell.ButtonEvent` (Button event)
- `2.170.32960` -- `Doorbell.Volume`
...
_V3 spec totals: 52 traits (3 supported, 7 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

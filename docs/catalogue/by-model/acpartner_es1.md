# lumi.acpartner.es1 -- Air conditioning Companion (B-end Exclusive Supply)
...
_V3 spec totals: 43 traits (10 supported, 0 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

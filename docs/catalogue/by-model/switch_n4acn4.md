# lumi.switch.n4acn4 -- Scene Panel Switch S1
...
_V3 spec totals: 72 traits (6 supported, 0 diagnostic, 0 button, 66 dropped). Generated by `tools/render_catalogue_docs.py`._

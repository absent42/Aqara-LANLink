# lumi.curtain.acn002 -- Roller Shade Driver E1
...
- `2.137.20034` -- `WindowCovering.WindowCoveringCategory` (Window covering category)
...
_V3 spec totals: 56 traits (11 supported, 0 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

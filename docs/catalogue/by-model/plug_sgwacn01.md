# lumi.plug.sgwacn01 -- Wall Outlet Hub
...
- `3.140.32944` -- `EnergyManagement.CurrentVoltage` (Current voltage)
...
_V3 spec totals: 36 traits (4 supported, 0 diagnostic, 0 button, 32 dropped). Generated by `tools/render_catalogue_docs.py`._

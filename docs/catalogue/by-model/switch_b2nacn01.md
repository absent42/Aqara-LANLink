# lumi.switch.b2nacn01 -- Smart Wall Switch T1 (With Neutral, Double Rocker)
...
_V3 spec totals: 65 traits (10 supported, 0 diagnostic, 0 button, 55 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sensor_magnet.v2 -- Door and Window Sensor
...
_V3 spec totals: 35 traits (1 supported, 2 diagnostic, 0 button, 32 dropped). Generated by `tools/render_catalogue_docs.py`._

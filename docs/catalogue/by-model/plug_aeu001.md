# lumi.plug.aeu001 -- Wall Outlet H2 EU
...
_V3 spec totals: 43 traits (4 supported, 0 diagnostic, 0 button, 39 dropped). Generated by `tools/render_catalogue_docs.py`._

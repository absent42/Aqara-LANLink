# aqara.lock.acn002 -- Fully Automatic Smart Door Lock with Camera

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | aqara.lock.acn002 |
...
_V3 spec totals: 32 traits (1 supported, 2 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

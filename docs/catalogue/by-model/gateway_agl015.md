# lumi.gateway.agl015 -- Panel Hub AX100S

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.gateway.agl015 |
...
- `12.143.32952` -- `Temperature.CurrentTemperature` (Current temperature)
- `13.144.32953` -- `RelativeHumidity.CurrentHumidity` (Current humidity)
...
_V3 spec totals: 109 traits (14 supported, 1 diagnostic, 0 button, 94 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sensor_ht.agl001 -- Climate Sensor W100

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.sensor_ht.agl001 |
...
_V3 spec totals: 51 traits (2 supported, 0 diagnostic, 0 button, 49 dropped). Generated by `tools/render_catalogue_docs.py`._

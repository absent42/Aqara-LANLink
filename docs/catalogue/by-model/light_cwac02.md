# lumi.light.cwac02 -- Aqara LED Light T1
...
_V3 spec totals: 37 traits (5 supported, 0 diagnostic, 0 button, 32 dropped). Generated by `tools/render_catalogue_docs.py`._

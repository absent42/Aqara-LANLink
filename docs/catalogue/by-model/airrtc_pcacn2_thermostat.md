# lumi.airrtc.pcacn2_thermostat -- Thermostat S3
...
- `2.141.32953` -- `HeaterCooler.CurrentHumidity` (Current humidity)
- `2.142.32950` -- `FanControl.FanMode` (Fan mode)
- `2.142.32951` -- `FanControl.RockSetting` (Rock setting)
...
_V3 spec totals: 63 traits (21 supported, 0 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

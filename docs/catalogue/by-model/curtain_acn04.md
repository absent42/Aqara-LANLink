# lumi.curtain.acn04 -- Smart Curtain Controller C3
...
- `2.137.20145` -- `WindowCovering.ManualPullEvent` (Manual pull event)
- `2.137.20185` -- `WindowCovering.MotorSpeedPercentage` (Motor speed percentage)
- `2.137.20186` -- `WindowCovering.ObstacleLimitMarkingEnable` (Obstacle limit marking enable)
...
_V3 spec totals: 58 traits (16 supported, 0 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

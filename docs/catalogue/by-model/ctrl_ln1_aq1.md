# lumi.ctrl_ln1.aq1 -- Wall Switch (With Neutral, Single Rocker)
...
_V3 spec totals: 37 traits (6 supported, 0 diagnostic, 0 button, 31 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.ctrl_neutral1.aq1 -- Wall Switch (No Neutral, Single Rocker)
...
_V3 spec totals: 29 traits (2 supported, 0 diagnostic, 0 button, 27 dropped). Generated by `tools/render_catalogue_docs.py`._

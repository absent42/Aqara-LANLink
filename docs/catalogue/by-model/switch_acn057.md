# lumi.switch.acn057 -- Smart wall switch Z1 Pro (double-button version)
...
_V3 spec totals: 66 traits (11 supported, 0 diagnostic, 0 button, 55 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.vibration.agl002 -- Multi-State Sensor P100

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.sensor.p100 |
...
- `1.175.20378` -- `GeneralConfiguration.DetectionModeSetting` (Detection mode setting)
- `1.175.33083` -- `GeneralConfiguration.CurrentSensitivityLevel` (Current sensitivity level)
- `2.164.20364` -- `Vibration.StationaryState` (Stationary state)
- `2.164.20370` -- `Vibration.InitialTiltAngle` (Initial tilt angle)
- `2.164.20371` -- `Vibration.TiltAngleDeviation` (Tilt angle deviation)
- `2.164.20372` -- `Vibration.PeakTiltAngle` (Peak tilt angle)
- `2.164.20373` -- `Vibration.StationaryTiltAngle` (Stationary tilt angle)
- `2.164.20374` -- `Vibration.ObjectMotionDetectionEnable` (Object motion detection enable)
- `2.164.20375` -- `Vibration.EventReportInterval` (Event report interval)
- `2.164.20376` -- `Vibration.ObjectOrientationState` (Object orientation state)
- `2.164.20377` -- `Vibration.ObjectOrientationEnable` (Object orientation enable)
- `2.164.20536` -- `Vibration.ObjectMotionDurThreshold` (Object motion dur threshold)
- `2.164.20537` -- `Vibration.ObjectMotionDuration` (Object motion duration)
- `2.164.20538` -- `Vibration.VibrationDurThreshold` (Vibration dur threshold)
- `2.164.20539` -- `Vibration.VibrationDuration` (Vibration duration)
- `2.164.33007` -- `Vibration.VibrationEvent` (Vibration event)
- `3.155.32990` -- `Contact.ContactSensorState` (Contact sensor state)
...
_V3 spec totals: 64 traits (17 supported, 2 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

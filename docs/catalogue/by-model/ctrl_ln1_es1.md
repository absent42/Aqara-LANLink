# lumi.ctrl_ln1.es1 -- Wall Switch (With Neutral, Single Rocker)
...
_V3 spec totals: 34 traits (5 supported, 0 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sen_ill.mgl01 -- lumi.sen_ill.mgl01
...
- `2.154.32989` -- `Illuminance.CurrentIlluminance` (Current illuminance)
...
_V3 spec totals: 44 traits (1 supported, 2 diagnostic, 0 button, 41 dropped). Generated by `tools/render_catalogue_docs.py`._

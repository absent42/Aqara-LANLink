# lumi.light.cwacn1 -- Aqara Smart Dimmer Controller T1（0-10V）
...
_V3 spec totals: 50 traits (8 supported, 0 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sensor_ht.v1 -- Humidity and Temperature Sensor
...
_V3 spec totals: 39 traits (2 supported, 2 diagnostic, 0 button, 35 dropped). Generated by `tools/render_catalogue_docs.py`._

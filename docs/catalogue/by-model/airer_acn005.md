# lumi.airer.acn005 -- Smart Clothes Drying Rack C100

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, US, unknown |
| Bundle IDs | lumi.airer.acn005 |
...
_V3 spec totals: 47 traits (6 supported, 0 diagnostic, 0 button, 41 dropped). Generated by `tools/render_catalogue_docs.py`._

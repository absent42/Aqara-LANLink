# lumi.remote.cagl02 -- Cube T1 Pro

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.remote.cagl02 |
...
- `2.163.20165` -- `Cube.TopFace` (Top face)
- `2.163.20166` -- `Cube.TopFaceChanged` (Top face changed)
- `2.163.20237` -- `Cube.CubeWorkModeSetting` (Cube work mode setting)
- `2.163.33006` -- `Cube.CubeEvent` (Cube event)
- `3.162.33003` -- `Knob.RotationAngle` (Rotation angle)
...
_V3 spec totals: 55 traits (5 supported, 2 diagnostic, 0 button, 48 dropped). Generated by `tools/render_catalogue_docs.py`._

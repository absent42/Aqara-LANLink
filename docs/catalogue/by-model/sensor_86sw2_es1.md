# lumi.sensor_86sw2.es1 -- lumi.sensor_86sw2.es1
...
_V3 spec totals: 50 traits (3 supported, 2 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

...
- `4.151.32982` -- `Pressure.CurrentPressure` (Current pressure)
...
_V3 spec totals: 54 traits (3 supported, 2 diagnostic, 0 button, 49 dropped). Generated by `tools/render_catalogue_docs.py`._

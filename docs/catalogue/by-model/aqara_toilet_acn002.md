# aqara.toilet.acn002 -- Smart Toilet T1
...
_V3 spec totals: 30 traits (0 supported, 0 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.curtain.acn018 -- Curtain Controller C200

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, US, unknown |
| Bundle IDs | lumi.curtain.acn018 |
...
_V3 spec totals: 40 traits (7 supported, 0 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

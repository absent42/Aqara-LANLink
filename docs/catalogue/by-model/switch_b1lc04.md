# lumi.switch.b1lc04 -- Smart Wall Switch E1 (No Neutral, Single Rocker)
...
_V3 spec totals: 46 traits (3 supported, 0 diagnostic, 0 button, 43 dropped). Generated by `tools/render_catalogue_docs.py`._

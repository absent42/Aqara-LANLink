# lumi.switch.b1naus01 -- Smart Wall Switch (With Neutral, Single Rocker)
...
_V3 spec totals: 39 traits (6 supported, 0 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

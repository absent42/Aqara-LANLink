# lumi.remote.b1acn02 -- Wireless Mini Switch T1
...
_V3 spec totals: 45 traits (1 supported, 2 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

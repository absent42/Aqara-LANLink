# lumi.camera.gwpgl1 -- Camera Hub G3
...
- `11.220.20218` -- `GestureRecognition.GestureRecognitionReport` (Gesture recognition report)
...
- `7.217.20214` -- `SoundDetection.AnomalySoundDetected` (Anomaly sound detected)
...
- `2.136.20030` -- `Camera.P2PCaptureEnabled` (P 2 P capture enabled)
- `2.136.20036` -- `Camera.P2PCaptureStatus` (P 2 P capture status)
- `2.136.32930` -- `Camera.CameraActiveStatus` (Camera active status)
...
_V3 spec totals: 83 traits (9 supported, 6 diagnostic, 0 button, 68 dropped). Generated by `tools/render_catalogue_docs.py`._

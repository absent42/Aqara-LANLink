# lumi.airm.fhac01 -- Aqara Air Quality Monitor S1
...
- `2.143.32952` -- `Temperature.CurrentTemperature` (Current temperature)
- `3.144.32953` -- `RelativeHumidity.CurrentHumidity` (Current humidity)
- `4.152.32983` -- `ParticulateMatter.PM2.5Density` (PM 2 5 density)
- `4.152.32984` -- `ParticulateMatter.PM2.5Level` (PM 2 5 level)
- `4.152.32985` -- `ParticulateMatter.PM1.0Density` (PM 1 0 density)
- `4.152.32986` -- `ParticulateMatter.PM10Density` (PM 10 density)
- `5.153.32987` -- `CO2.CO2Density` (CO 2 density)
- `5.153.32988` -- `CO2.CO2Level` (CO 2 level)
...
_V3 spec totals: 65 traits (8 supported, 0 diagnostic, 0 button, 57 dropped). Generated by `tools/render_catalogue_docs.py`._

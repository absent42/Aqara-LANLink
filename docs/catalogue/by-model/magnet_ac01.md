# lumi.magnet.ac01 -- Door and Window Sensor P1
...
_V3 spec totals: 48 traits (1 supported, 2 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.l2acn1 -- Wall Switch H1 (No Neutral, Double Rocker)
...
_V3 spec totals: 60 traits (7 supported, 0 diagnostic, 0 button, 53 dropped). Generated by `tools/render_catalogue_docs.py`._

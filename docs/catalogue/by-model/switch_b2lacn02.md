# lumi.switch.b2lacn02 -- Smart Wall Switch D1 (No Neutral, Double Rocker)
...
_V3 spec totals: 55 traits (8 supported, 0 diagnostic, 0 button, 47 dropped). Generated by `tools/render_catalogue_docs.py`._

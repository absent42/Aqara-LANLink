# lumi.switch.acn044 -- Smart Wall Switch J1 (With Neutral, Single Rocker)
...
_V3 spec totals: 50 traits (6 supported, 0 diagnostic, 0 button, 44 dropped). Generated by `tools/render_catalogue_docs.py`._

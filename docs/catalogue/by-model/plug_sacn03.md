# lumi.plug.sacn03 -- Smart Wall Outlet H1(USB)
...
_V3 spec totals: 46 traits (5 supported, 0 diagnostic, 0 button, 41 dropped). Generated by `tools/render_catalogue_docs.py`._

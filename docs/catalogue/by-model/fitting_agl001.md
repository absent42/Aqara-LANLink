# lumi.fitting.agl001 -- Curtain Driver

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, unknown |
| Bundle IDs | lumi.fitting.agl001 |
...
- `1.147.20028` -- `PowerSource.Rechargeable`
- `1.147.32973` -- `PowerSource.BatPercentRemaining` (Bat percent remaining)
- `1.147.33115` -- `PowerSource.WiredPresent` (Wired present)
- `2.140.20029` -- `EnergyManagement.CircuitCurrent` (Circuit current)
...
- `3.140.20029` -- `EnergyManagement.CircuitCurrent` (Circuit current)
...
- `0.128.33048` -- `BasicInformation.ProductID` (Product ID)

---

_V3 spec totals: 53 traits (12 supported, 3 diagnostic, 0 button, 38 dropped). Generated by `tools/render_catalogue_docs.py`._

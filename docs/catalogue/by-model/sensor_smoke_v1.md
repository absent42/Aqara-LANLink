# lumi.sensor_smoke.v1 -- Smoke Detector
...
_V3 spec totals: 44 traits (2 supported, 2 diagnostic, 0 button, 40 dropped). Generated by `tools/render_catalogue_docs.py`._

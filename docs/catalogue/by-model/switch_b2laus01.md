# lumi.switch.b2laus01 -- Smart Wall Switch (No Neutral, Double Rocker)
...
_V3 spec totals: 51 traits (7 supported, 0 diagnostic, 0 button, 44 dropped). Generated by `tools/render_catalogue_docs.py`._

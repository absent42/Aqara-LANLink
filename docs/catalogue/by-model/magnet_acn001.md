# lumi.magnet.acn001 -- Door and Window Sensor E1
...
_V3 spec totals: 40 traits (1 supported, 2 diagnostic, 0 button, 37 dropped). Generated by `tools/render_catalogue_docs.py`._

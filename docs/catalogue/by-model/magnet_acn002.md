# lumi.magnet.acn002 -- Door and Window Sensor NB-IOT Edition
...
_V3 spec totals: 31 traits (1 supported, 1 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

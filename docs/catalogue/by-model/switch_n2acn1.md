# lumi.switch.n2acn1 -- Wall Switch H1 (With Neutral, Double Rocker)
...
_V3 spec totals: 64 traits (9 supported, 0 diagnostic, 0 button, 55 dropped). Generated by `tools/render_catalogue_docs.py`._

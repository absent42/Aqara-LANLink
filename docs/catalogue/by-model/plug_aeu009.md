# lumi.plug.aeu009 -- Power Plug H2

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.plug.move |
...
_V3 spec totals: 34 traits (4 supported, 0 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.b2naus01 -- Smart Wall Switch (With Neutral, Double Rocker)
...
_V3 spec totals: 58 traits (10 supported, 0 diagnostic, 0 button, 48 dropped). Generated by `tools/render_catalogue_docs.py`._

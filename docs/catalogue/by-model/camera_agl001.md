# lumi.camera.agl001 -- Camera Hub G2H Pro
...
_V3 spec totals: 73 traits (7 supported, 6 diagnostic, 0 button, 60 dropped). Generated by `tools/render_catalogue_docs.py`._

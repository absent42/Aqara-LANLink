# lumi.plug.v1 -- Smart Plug (China Standard)
...
_V3 spec totals: 42 traits (4 supported, 0 diagnostic, 0 button, 38 dropped). Generated by `tools/render_catalogue_docs.py`._

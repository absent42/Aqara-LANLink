# lumi.lock.acn02 -- Smart Door Lock S2
...
_V3 spec totals: 38 traits (1 supported, 1 diagnostic, 0 button, 36 dropped). Generated by `tools/render_catalogue_docs.py`._

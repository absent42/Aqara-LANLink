# lumi.relay.c4acn01 -- Wireless Relay Controller (4 Channels)
...
- `2.140.32945` -- `EnergyManagement.CurrentPower` (Current power)
- `2.140.32946` -- `EnergyManagement.CumulativeEnergyConsumption` (Cumulative energy consumption)
- `3.132.32920` -- `Output.OnOff` (On off)
- `3.140.32945` -- `EnergyManagement.CurrentPower` (Current power)
- `3.140.32946` -- `EnergyManagement.CumulativeEnergyConsumption` (Cumulative energy consumption)
- `4.132.32920` -- `Output.OnOff` (On off)
- `4.140.32945` -- `EnergyManagement.CurrentPower` (Current power)
- `4.140.32946` -- `EnergyManagement.CumulativeEnergyConsumption` (Cumulative energy consumption)
- `5.132.32920` -- `Output.OnOff` (On off)
- `5.140.32945` -- `EnergyManagement.CurrentPower` (Current power)
- `5.140.32946` -- `EnergyManagement.CumulativeEnergyConsumption` (Cumulative energy consumption)
...
_V3 spec totals: 75 traits (15 supported, 0 diagnostic, 0 button, 60 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.light.acn041 -- Sky Mirror V1

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.light.acn041 |
...
_V3 spec totals: 53 traits (16 supported, 0 diagnostic, 0 button, 37 dropped). Generated by `tools/render_catalogue_docs.py`._

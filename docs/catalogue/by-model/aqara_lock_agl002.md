# aqara.lock.agl002 -- Smart door lock A100 (International version)

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU, US |
| Bundle IDs | aqara.lock.agl002 |
...
_V3 spec totals: 35 traits (6 supported, 1 diagnostic, 0 button, 28 dropped). Generated by `tools/render_catalogue_docs.py`._

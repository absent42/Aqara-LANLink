# lumi.camera.agl003 -- Camera Hub G5 Pro (Wi-Fi)
...
_V3 spec totals: 60 traits (4 supported, 3 diagnostic, 0 button, 53 dropped). Generated by `tools/render_catalogue_docs.py`._

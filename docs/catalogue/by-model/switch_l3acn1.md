# lumi.switch.l3acn1 -- Wall Switch H1 (No Neutral, Three Rocker)

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.switch.legacy_upgrade |
...
_V3 spec totals: 66 traits (12 supported, 0 diagnostic, 0 button, 54 dropped). Generated by `tools/render_catalogue_docs.py`._

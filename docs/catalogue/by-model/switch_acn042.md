# lumi.switch.acn042 -- Smart Wall Switch J1 (No Neutral, Double Rocker)
...
_V3 spec totals: 62 traits (7 supported, 0 diagnostic, 0 button, 55 dropped). Generated by `tools/render_catalogue_docs.py`._

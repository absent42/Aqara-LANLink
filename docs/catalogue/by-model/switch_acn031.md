# lumi.switch.acn031 -- Smart Wall Switch H1M (With Neutral, Triple Rocker)
...
_V3 spec totals: 84 traits (15 supported, 0 diagnostic, 0 button, 69 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.b2lc04 -- Smart Wall Switch E1 (No Neutral, Double Rocker)
...
_V3 spec totals: 58 traits (6 supported, 0 diagnostic, 0 button, 52 dropped). Generated by `tools/render_catalogue_docs.py`._

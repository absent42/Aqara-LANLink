# lumi.light.agl003 -- LED Bulb T2 (RGB+CCT)
...
| Regions | EU, US |
| Bundle IDs | (none) |
| Models (whitelabels) | lumi.light.agl001, lumi.light.agl003, lumi.light.agl005 |
| Whitelabel names | `lumi.light.agl001` = LED Bulb T2 (E26, RGB+CCT), `lumi.light.agl003` = LED Bulb T2 (E27, RGB+CCT), `lumi.light.agl005` = LED Bulb T2 (GU10, RGB+CCT, 230V) |
...
_V3 spec totals: 46 traits (11 supported, 0 diagnostic, 0 button, 35 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sensor_magnet.aq2 -- Door and Window Sensor
...
- `2.155.32990` -- `Contact.ContactSensorState` (Contact sensor state)
...
_V3 spec totals: 36 traits (1 supported, 2 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

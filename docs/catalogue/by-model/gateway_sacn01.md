# lumi.gateway.sacn01 -- Smart USB Wall Outlet H1 Hub
...
_V3 spec totals: 38 traits (4 supported, 1 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

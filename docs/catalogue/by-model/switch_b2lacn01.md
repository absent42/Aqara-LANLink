# lumi.switch.b2lacn01 -- Smart Wall Switch T1 (No Neutral, Double Rocker)
...
_V3 spec totals: 54 traits (8 supported, 0 diagnostic, 0 button, 46 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.aeu003 -- Shutter Switch H2

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU, US |
| Bundle IDs | lumi.switch.aeu003 |
...
_V3 spec totals: 45 traits (8 supported, 0 diagnostic, 0 button, 37 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.ctrl_dualchn.es1 -- Dual control module
...
_V3 spec totals: 51 traits (6 supported, 0 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

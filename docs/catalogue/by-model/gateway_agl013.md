# lumi.gateway.agl013 -- Gateway RS-485

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, unknown |
| Bundle IDs | lumi.gateway.agl013 |
...
_V3 spec totals: 29 traits (1 supported, 0 diagnostic, 0 button, 28 dropped). Generated by `tools/render_catalogue_docs.py`._

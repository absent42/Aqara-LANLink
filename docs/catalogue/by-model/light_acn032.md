# lumi.light.acn032 -- Ceiling Light T1M
...
- `2.134.20107` -- `ColorControl.StartUpColorTemperature` (Start up color temperature)
...
- `3.134.20192` -- `ColorControl.ColorXY` (Color XY)
- `3.134.32924` -- `ColorControl.ColorMode` (Color mode)
- `3.134.32925` -- `ColorControl.CurrentX` (Current X)
- `3.134.32926` -- `ColorControl.CurrentY` (Current Y)
...
_V3 spec totals: 61 traits (15 supported, 0 diagnostic, 0 button, 46 dropped). Generated by `tools/render_catalogue_docs.py`._

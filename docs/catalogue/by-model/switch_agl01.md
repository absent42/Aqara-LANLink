# lumi.switch.agl01 -- Switch T1

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.switch.agl01 |
...
- `2.182.33116` -- `GarageDoorOpener.CurrentGarageDoorState` (Current garage door state)
- `2.182.33117` -- `GarageDoorOpener.TargetGarageDoorState` (Target garage door state)
...
_V3 spec totals: 36 traits (5 supported, 0 diagnostic, 0 button, 31 dropped). Generated by `tools/render_catalogue_docs.py`._

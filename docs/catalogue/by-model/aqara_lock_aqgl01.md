# aqara.lock.aqgl01 -- Smart Automatic Door Lock D100 (International Version)

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU, US |
| Bundle IDs | aqara.lock.aqgl01 |
...
_V3 spec totals: 36 traits (6 supported, 1 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

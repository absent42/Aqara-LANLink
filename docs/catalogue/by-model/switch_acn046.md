# lumi.switch.acn046 -- Smart Wall Switch J1 (With Neutral, Triple Rocker)
...
_V3 spec totals: 87 traits (15 supported, 0 diagnostic, 0 button, 72 dropped). Generated by `tools/render_catalogue_docs.py`._

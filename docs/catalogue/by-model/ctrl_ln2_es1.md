# lumi.ctrl_ln2.es1 -- Wall Switch (With Neutral, Double Rocker)
...
_V3 spec totals: 49 traits (8 supported, 0 diagnostic, 0 button, 41 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.b1nacn01 -- Smart Wall Switch T1 (With Neutral, Single Rocker)
...
_V3 spec totals: 47 traits (7 supported, 0 diagnostic, 0 button, 40 dropped). Generated by `tools/render_catalogue_docs.py`._

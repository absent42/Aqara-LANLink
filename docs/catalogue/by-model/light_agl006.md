# lumi.light.agl006 -- LED Bulb T2 (GU10, CCT)

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | aqara.matter.light |
| Models (whitelabels) | lumi.light.agl006, lumi.light.agl007 |
| Whitelabel names | `lumi.light.agl006` = LED Bulb T2 (GU10, CCT, 230V), `lumi.light.agl007` = LED Bulb T2 (GU10, CCT, 110V) |
...
_V3 spec totals: 43 traits (8 supported, 0 diagnostic, 0 button, 35 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.b1nc01 -- Smart Wall Switch E1 (With Neutral, Single Rocker)
...
_V3 spec totals: 47 traits (3 supported, 0 diagnostic, 0 button, 44 dropped). Generated by `tools/render_catalogue_docs.py`._

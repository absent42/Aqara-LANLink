# lumi.sensor_natgas.v1 -- Smart Natural Gas Detector
...
_V3 spec totals: 42 traits (2 supported, 0 diagnostic, 0 button, 40 dropped). Generated by `tools/render_catalogue_docs.py`._

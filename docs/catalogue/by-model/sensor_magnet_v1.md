# lumi.sensor_magnet.v1 -- Door and Window Sensor
...
_V3 spec totals: 33 traits (1 supported, 2 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

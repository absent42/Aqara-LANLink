# aqara.lock.bzacn4 -- Smart Door Lock N100

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | aqara.lock.bzacn3 |
...
_V3 spec totals: 34 traits (2 supported, 1 diagnostic, 0 button, 31 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.plug.sacn02 -- Smart Wall Outlet T1
...
_V3 spec totals: 51 traits (5 supported, 0 diagnostic, 0 button, 46 dropped). Generated by `tools/render_catalogue_docs.py`._

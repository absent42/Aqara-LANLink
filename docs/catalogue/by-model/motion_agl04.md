# lumi.motion.agl04 -- High Precision Motion Sensor
...
_V3 spec totals: 47 traits (3 supported, 2 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.l1acn1 -- Wall Switch H1 (No Neutral, Single Rocker)
...
_V3 spec totals: 39 traits (4 supported, 0 diagnostic, 0 button, 35 dropped). Generated by `tools/render_catalogue_docs.py`._

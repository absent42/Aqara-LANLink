# aqara.feeder.acn001 -- Smart Pet Feeder C1
...
_V3 spec totals: 31 traits (1 supported, 0 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.lock.aus001 -- Smart Lock B50

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | US |
| Bundle IDs | lumi.lock.aus001 |
...
_V3 spec totals: 34 traits (5 supported, 1 diagnostic, 0 button, 28 dropped). Generated by `tools/render_catalogue_docs.py`._

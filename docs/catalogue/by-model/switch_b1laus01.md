# lumi.switch.b1laus01 -- Smart Wall Switch (No Neutral, Single Rocker)
...
_V3 spec totals: 35 traits (3 supported, 0 diagnostic, 0 button, 32 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.acn080 -- Elite Switch H2

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.switch.acn080 |
...
- `5.135.33109` -- `Button.LocalControlDisabled` (Local control disabled)
- `6.135.32928` -- `Button.ButtonEvent` (Button event)
- `6.135.33109` -- `Button.LocalControlDisabled` (Local control disabled)
- `7.135.32928` -- `Button.ButtonEvent` (Button event)
- `7.135.33109` -- `Button.LocalControlDisabled` (Local control disabled)
- `8.135.32928` -- `Button.ButtonEvent` (Button event)
- `9.160.33000` -- `OccupancySensing.Occupancy`
- `9.160.33001` -- `OccupancySensing.OccupancySensorType` (Occupancy sensor type)
...
_V3 spec totals: 85 traits (15 supported, 0 diagnostic, 0 button, 70 dropped). Generated by `tools/render_catalogue_docs.py`._

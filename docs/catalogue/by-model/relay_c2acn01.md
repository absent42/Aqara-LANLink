# lumi.relay.c2acn01 -- Dual control module
...
_V3 spec totals: 54 traits (6 supported, 0 diagnostic, 0 button, 48 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.b1lacn01 -- Smart Wall Switch T1 (No Neutral, Single Rocker)
...
_V3 spec totals: 34 traits (3 supported, 0 diagnostic, 0 button, 31 dropped). Generated by `tools/render_catalogue_docs.py`._

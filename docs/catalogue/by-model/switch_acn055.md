# lumi.switch.acn055 -- Canon Smart Wall Switch Z1(Quadruple Rocker)
...
_V3 spec totals: 81 traits (15 supported, 0 diagnostic, 0 button, 66 dropped). Generated by `tools/render_catalogue_docs.py`._

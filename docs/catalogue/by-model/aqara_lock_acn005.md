# aqara.lock.acn005 -- Smart Lock D200i

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU, US |
| Bundle IDs | aqara.lock.acn005 |
...
- `2.148.40000` -- `DoorLock.RemoteControlWithAuthCode` (Remote control with auth code)
...
_V3 spec totals: 37 traits (6 supported, 1 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

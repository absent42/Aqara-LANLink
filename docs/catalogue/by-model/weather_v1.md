# lumi.weather.v1 -- Temperature and Humidity Sensor
...
_V3 spec totals: 44 traits (3 supported, 2 diagnostic, 0 button, 39 dropped). Generated by `tools/render_catalogue_docs.py`._

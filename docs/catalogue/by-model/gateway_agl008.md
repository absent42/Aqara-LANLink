# lumi.gateway.agl008 -- Hub M100

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU, US |
| Bundle IDs | lumi.gateway.agl008 |
...
_V3 spec totals: 29 traits (0 supported, 0 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

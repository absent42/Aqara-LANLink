# lumi.light.acn040 -- Downlight T2 Pro
...
_V3 spec totals: 38 traits (5 supported, 0 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

# aqara.lock.acn004 -- Smart Lock D200

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, US, unknown |
| Bundle IDs | aqara.lock.acn004 |
...
_V3 spec totals: 37 traits (5 supported, 1 diagnostic, 0 button, 31 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.lock.acn04 -- Smart Door Lock HL

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, unknown |
| Bundle IDs | lumi.lock.acn04 |
...
_V3 spec totals: 35 traits (2 supported, 1 diagnostic, 0 button, 32 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sensor_smoke.acn02 -- lumi.sensor_smoke.acn02
...
- `2.156.32991` -- `Smoke.SmokeDensity` (Smoke density)
- `2.156.32992` -- `Smoke.SmokeDetected` (Smoke detected)
...
_V3 spec totals: 33 traits (2 supported, 2 diagnostic, 0 button, 29 dropped). Generated by `tools/render_catalogue_docs.py`._

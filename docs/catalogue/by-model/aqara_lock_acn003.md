# aqara.lock.acn003 -- aqara.lock.acn003
...
_V3 spec totals: 33 traits (2 supported, 1 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.agl011 -- Dimmer Switch H2

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | EU, US |
| Bundle IDs | aqara.matter.rotary |
...
- `0.130.32919` -- `EndpointLabel.EndpointIcon` (Endpoint icon)
...
_V3 spec totals: 38 traits (4 supported, 0 diagnostic, 0 button, 34 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.dimmer.rcbac1 -- Aqara Smart Lightstrip Driver
...
- `1.175.20099` -- `GeneralConfiguration.LightingModeSetting` (Lighting mode setting)
...
- `2.134.20192` -- `ColorControl.ColorXY` (Color XY)
- `2.134.32924` -- `ColorControl.ColorMode` (Color mode)
- `2.134.32925` -- `ColorControl.CurrentX` (Current X)
- `2.134.32926` -- `ColorControl.CurrentY` (Current Y)
...
- `3.134.32924` -- `ColorControl.ColorMode` (Color mode)
- `3.134.32927` -- `ColorControl.ColorTemperature` (Color temperature)
- `4.132.32920` -- `Output.OnOff` (On off)
- `4.132.32921` -- `Output.StartUpOnOff` (Start up on off)
- `4.133.32923` -- `LevelControl.CurrentLevel` (Current level)
- `4.133.33125` -- `LevelControl.OnTransitionTime` (On transition time)
- `4.133.33126` -- `LevelControl.OffTransitionTime` (Off transition time)
- `4.134.32924` -- `ColorControl.ColorMode` (Color mode)
- `4.134.32927` -- `ColorControl.ColorTemperature` (Color temperature)
...
_V3 spec totals: 81 traits (27 supported, 0 diagnostic, 0 button, 54 dropped). Generated by `tools/render_catalogue_docs.py`._

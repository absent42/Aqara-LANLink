# aqara.speaker.hpcn03 -- Background Music Preferred-Single Auto Source
...
_V3 spec totals: 35 traits (7 supported, 0 diagnostic, 0 button, 28 dropped). Generated by `tools/render_catalogue_docs.py`._

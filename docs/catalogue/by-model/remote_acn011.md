# lumi.remote.acn011 -- Wireless Remote Switch J1 (Single Rocker)
...
_V3 spec totals: 48 traits (2 supported, 2 diagnostic, 0 button, 44 dropped). Generated by `tools/render_catalogue_docs.py`._

...
- `2.134.20204` -- `ColorControl.LightingDynamicSceneMode` (Lighting dynamic scene mode)
- `2.134.20205` -- `ColorControl.LightingMusicSyncEnable` (Lighting music sync enable)
- `2.134.20206` -- `ColorControl.LightingMusicSyncMode` (Lighting music sync mode)
- `2.134.20459` -- `ColorControl.LightStripSegmentCount` (Light strip segment count)
...
_V3 spec totals: 57 traits (15 supported, 0 diagnostic, 0 button, 42 dropped). Generated by `tools/render_catalogue_docs.py`._

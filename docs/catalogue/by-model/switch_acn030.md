# lumi.switch.acn030 -- Smart Wall Switch H1M (With Neutral, Double Rocker)
...
_V3 spec totals: 61 traits (10 supported, 0 diagnostic, 0 button, 51 dropped). Generated by `tools/render_catalogue_docs.py`._

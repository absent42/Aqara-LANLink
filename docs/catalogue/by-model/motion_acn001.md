...
- `2.160.20082` -- `OccupancySensing.HoldTime` (Hold time)
- `2.160.33000` -- `OccupancySensing.Occupancy`
- `2.160.33001` -- `OccupancySensing.OccupancySensorType` (Occupancy sensor type)
- `3.154.32989` -- `Illuminance.CurrentIlluminance` (Current illuminance)
...
_V3 spec totals: 47 traits (4 supported, 2 diagnostic, 0 button, 41 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.curtain.acn011 -- lumi.curtain.acn011
...
- `2.137.33112` -- `WindowCovering.CurrentRotationAngle` (Current rotation angle)
- `2.137.33113` -- `WindowCovering.TargetRotationAngle` (Target rotation angle)
...
_V3 spec totals: 60 traits (14 supported, 0 diagnostic, 0 button, 46 dropped). Generated by `tools/render_catalogue_docs.py`._

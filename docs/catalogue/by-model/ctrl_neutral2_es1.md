# lumi.ctrl_neutral2.es1 -- Wall Switch (No Neutral, Double Rocker)
...
_V3 spec totals: 49 traits (6 supported, 0 diagnostic, 0 button, 43 dropped). Generated by `tools/render_catalogue_docs.py`._

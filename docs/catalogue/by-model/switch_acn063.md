# lumi.switch.acn063 -- Smart wall switch Q1 (double-button version)
...
_V3 spec totals: 74 traits (11 supported, 0 diagnostic, 0 button, 63 dropped). Generated by `tools/render_catalogue_docs.py`._

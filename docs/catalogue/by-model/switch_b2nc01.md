# lumi.switch.b2nc01 -- Smart Wall Switch E1 (With Neutral, Double Rocker)

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.switch.b1nc01 |
...
_V3 spec totals: 59 traits (6 supported, 0 diagnostic, 0 button, 53 dropped). Generated by `tools/render_catalogue_docs.py`._

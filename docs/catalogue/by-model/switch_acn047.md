...
- `2.132.20101` -- `Output.OutputInterlockFlag` (Output interlock flag)
- `2.132.20102` -- `Output.OutputNodeMode` (Output node mode)
- `2.132.20103` -- `Output.OutputSwitchingType` (Output switching type)
- `2.132.32920` -- `Output.OnOff` (On off)
- `3.132.20101` -- `Output.OutputInterlockFlag` (Output interlock flag)
- `3.132.20102` -- `Output.OutputNodeMode` (Output node mode)
- `3.132.20103` -- `Output.OutputSwitchingType` (Output switching type)
...
_V3 spec totals: 57 traits (12 supported, 0 diagnostic, 0 button, 45 dropped). Generated by `tools/render_catalogue_docs.py`._

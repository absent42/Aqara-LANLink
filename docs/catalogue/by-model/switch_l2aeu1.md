# lumi.switch.l2aeu1 -- Smart Wall Switch H1 EU (No Neutral, Double Rocker)
...
_V3 spec totals: 42 traits (6 supported, 0 diagnostic, 0 button, 36 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.n2aeu1 -- Smart Wall Switch H1 EU (With Neutral, Double Rocker)
...
_V3 spec totals: 47 traits (8 supported, 0 diagnostic, 0 button, 39 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.remote.b286acn03 -- Wireless Remote Switch T1 (Double Rocker)
...
_V3 spec totals: 53 traits (3 supported, 2 diagnostic, 0 button, 48 dropped). Generated by `tools/render_catalogue_docs.py`._

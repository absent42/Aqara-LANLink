# lumi.sensor_motion.v2 -- Motion Sensor
...
_V3 spec totals: 43 traits (2 supported, 2 diagnostic, 0 button, 39 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.switch.rkna01 -- Smart Knob H1 (With Neutral)
...
- `2.162.33003` -- `Knob.RotationAngle` (Rotation angle)
- `2.162.33004` -- `Knob.RotationDirection` (Rotation direction)
- `2.162.33005` -- `Knob.RotationEvent` (Rotation event)
...
_V3 spec totals: 73 traits (10 supported, 0 diagnostic, 0 button, 63 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.ctrl_ln2.aq1 -- Wall Switch (With Neutral, Double Rocker)
...
_V3 spec totals: 53 traits (10 supported, 0 diagnostic, 0 button, 43 dropped). Generated by `tools/render_catalogue_docs.py`._

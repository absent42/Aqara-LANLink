# lumi.ctrl_ln1.v1 -- Wall Switch (With Neutral, Single Rocker)
...
_V3 spec totals: 35 traits (5 supported, 0 diagnostic, 0 button, 30 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.remote.b286acn01 -- Wireless Remote Switch (Double Rocker)
...
_V3 spec totals: 52 traits (3 supported, 2 diagnostic, 0 button, 47 dropped). Generated by `tools/render_catalogue_docs.py`._

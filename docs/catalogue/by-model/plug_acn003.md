# lumi.plug.acn003 -- Smart Wall Plug X1(USB)
...
_V3 spec totals: 37 traits (4 supported, 0 diagnostic, 0 button, 33 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.light.cwjwcn01 -- Spot Light（Adjustable Color Temperature）
...
_V3 spec totals: 45 traits (5 supported, 0 diagnostic, 0 button, 40 dropped). Generated by `tools/render_catalogue_docs.py`._

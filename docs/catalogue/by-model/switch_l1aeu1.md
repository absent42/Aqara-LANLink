# lumi.switch.l1aeu1 -- Smart Wall Switch H1 EU (No Neutral, Single Rocker)
...
_V3 spec totals: 30 traits (3 supported, 0 diagnostic, 0 button, 27 dropped). Generated by `tools/render_catalogue_docs.py`._

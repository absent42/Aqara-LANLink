# lumi.proj.dbcn02 -- Dangbei projector
...
_V3 spec totals: 28 traits (1 supported, 0 diagnostic, 0 button, 27 dropped). Generated by `tools/render_catalogue_docs.py`._

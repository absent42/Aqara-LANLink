# lumi.sensor_occupy.agl8 -- Presence Multi-Sensor FP300

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.sensor.fp3 |
...
- `4.143.32952` -- `Temperature.CurrentTemperature` (Current temperature)
- `5.144.32953` -- `RelativeHumidity.CurrentHumidity` (Current humidity)
- `6.154.32989` -- `Illuminance.CurrentIlluminance` (Current illuminance)
...
_V3 spec totals: 49 traits (5 supported, 0 diagnostic, 0 button, 44 dropped). Generated by `tools/render_catalogue_docs.py`._

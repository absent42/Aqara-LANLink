# lumi.switch.n1aeu1 -- Smart Wall Switch H1 EU (With Neutral, Single Rocker)
...
_V3 spec totals: 32 traits (5 supported, 0 diagnostic, 0 button, 27 dropped). Generated by `tools/render_catalogue_docs.py`._

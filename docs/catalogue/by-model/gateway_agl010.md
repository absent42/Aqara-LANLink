# lumi.gateway.agl010 -- Hub M100

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, unknown |
| Bundle IDs | lumi.gateway.agl010 |
...
_V3 spec totals: 39 traits (0 supported, 2 diagnostic, 0 button, 37 dropped). Generated by `tools/render_catalogue_docs.py`._

# lumi.sensor_smoke.acn03 -- Smoke Detector
...
- `2.156.20104` -- `Smoke.SelfCheck` (Self check)
- `2.156.32961` -- `Smoke.Mute`
...
_V3 spec totals: 49 traits (3 supported, 2 diagnostic, 0 button, 44 dropped). Generated by `tools/render_catalogue_docs.py`._

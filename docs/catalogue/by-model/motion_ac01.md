# lumi.motion.ac01 -- Presence Sensor FP1

| Field | Value |
|---|---|
| Manufacturer | Aqara |
| Regions | CN, EU, US, unknown |
| Bundle IDs | lumi.motion.ac01 |
...
_V3 spec totals: 53 traits (3 supported, 0 diagnostic, 0 button, 50 dropped). Generated by `tools/render_catalogue_docs.py`._

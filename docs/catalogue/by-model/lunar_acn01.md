# lumi.lunar.acn01 -- Aqara Sleeping Belt
...
- `2.158.32995` -- `Sleep.SleepState` (Sleep state)
- `2.158.32996` -- `Sleep.SleepQuality` (Sleep quality)
- `2.158.32997` -- `Sleep.OnBed` (On bed)
- `2.158.32998` -- `Sleep.SleepStage` (Sleep stage)
- `3.225.20232` -- `HeartMonitoring.HeartRate` (Heart rate)
- `4.226.20231` -- `BreathingMonitoring.BreathingRate` (Breathing rate)
...
_V3 spec totals: 44 traits (6 supported, 0 diagnostic, 0 button, 38 dropped). Generated by `tools/render_catalogue_docs.py`._

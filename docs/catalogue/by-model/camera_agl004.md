# lumi.camera.agl004 -- Camera Hub G5 Pro (Wi-Fi)
...
- `2.136.20369` -- `Camera.CameraRTSPEnable` (Camera RTSP enable)
...
- `2.136.20368` -- `Camera.CameraRTSPURL` (Camera RTSPURL)
...
_V3 spec totals: 65 traits (4 supported, 6 diagnostic, 0 button, 55 dropped). Generated by `tools/render_catalogue_docs.py`._
